...
const { registerUser, loginUser, logout, getUserDetails, updatePassword, updateProfile, getAllUsers , updateUserRole, deleteUser, getSingleUser, verify } = require("../controllers/userController");
